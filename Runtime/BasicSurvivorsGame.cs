...
namespace Deucarian.TemplateGameSurvivors
{
    ...
    public sealed class SurvivorsTemplateTuning
    {
        ...
        public float HordeRushFirstTimeSeconds = 105f;
        public float HordeRushIntervalSeconds = 150f;
        public float HordeRushWarningLeadSeconds = 5f;
        public int HordeRushBaseEnemyCount = 10;
        ...
        public float GemRushDurationSeconds = 3.2f;
        public float GemRushDamageBonus = 0.75f;
        public float GemRushMoveSpeedBonus = 0.16f;
        public float GemRushCooldownMultiplierBonus = -0.025f;
        public float GemRushPickupRangeBonus = 0.45f;
        ...
        public int RoamingCacheAmbushStartCache = 4;
        public int RoamingCacheAmbushInterval = 4;
        ...
        public float ArenaShrineTravelInterval = 72f;
        ...
        public float WeaponLoadoutSurgeDamageBonus = 1.2f;
        public float WeaponLoadoutSurgeMoveSpeedBonus = 0.16f;
        public float WeaponLoadoutSurgeCooldownMultiplierBonus = -0.035f;
        public float WeaponLoadoutSurgePickupRangeBonus = 0.35f;
        public float WeaponLoadoutSurgePulseDamage = 16f;
        public float WeaponLoadoutSurgePulseRadius = 4.8f;
        public float PassiveLoadoutSurgeDurationSeconds = 5.5f;
        public float PassiveLoadoutSurgeDamageBonus = 0.95f;
        public float PassiveLoadoutSurgeMoveSpeedBonus = 0.14f;
        public float PassiveLoadoutSurgeCooldownMultiplierBonus = -0.028f;
        public float PassiveLoadoutSurgePickupRangeBonus = 0.65f;
        public float PassiveLoadoutSurgeExperienceGainMultiplierBonus = 0.22f;
        public float PassiveLoadoutSurgePulseDamage = 14f;
        ...
        public float EvolutionChainSurgeDamageBonus = 1.4f;
        public float EvolutionChainSurgeMoveSpeedBonus = 0.18f;
        public float EvolutionChainSurgeCooldownMultiplierBonus = -0.04f;
        public float EvolutionChainSurgePickupRangeBonus = 0.45f;
        public float EvolutionChainSurgePulseDamage = 22f;
        public float EvolutionChainSurgePulseRadius = 5.4f;
        ...
        public float BossRelicSurgeDamageBonus = 1.1f;
        public float BossRelicSurgeMoveSpeedBonus = 0.16f;
        public float BossRelicSurgeCooldownMultiplierBonus = -0.035f;
        public float BossRelicSurgePickupRangeBonus = 0.35f;
