...
namespace Deucarian.TemplateGameSurvivors
{
    ...
    public sealed class SurvivorsTemplateTuning
    {
        ...
        public float DashCooldownSeconds = 2.45f;
        ...
        public int EnemyMaximumAlive = 38;
        public int EnemySpawnPackBaseCount = 2;
        public int EnemySpawnPackMaxCount = 6;
        public int EnemySpawnPackIncreaseEveryEscalations = 2;
        public float EnemyMaxHealth = 12.5f;
        public float EnemyMoveSpeed = 1.35f;
        public float EnemyRadius = 0.48f;
        public float EnemySeparationRadius = 0.95f;
        public float EnemySeparationStrength = 0.75f;
        ...
        public float HordeRushFirstTimeSeconds = 75f;
        public float HordeRushIntervalSeconds = 135f;
        public float HordeRushWarningLeadSeconds = 4f;
        public int HordeRushBaseEnemyCount = 12;
        public int HordeRushEnemyCountIncreasePerRush = 3;
        public int HordeRushMaxEnemyCount = 32;
        public int HordeRushExtraAliveAllowance = 20;
        ...
        public float HordeRushClearPulseDamage = 15f;
        public float HordeRushClearPulseRadius = 5f;
        public float HordeRushClearSurgeDurationSeconds = 5.5f;
        public float HordeRushClearSurgeDamageBonus = 1.55f;
        public float HordeRushClearSurgeMoveSpeedBonus = 0.22f;
        public float HordeRushClearSurgeCooldownMultiplierBonus = -0.045f;
        public float HordeRushClearSurgePickupRangeBonus = 0.48f;
        ...
        public float FirstEliteSpawnTimeSeconds = 135f;
        public float EliteSpawnIntervalSeconds = 180f;
        public float FirstDreadEliteSpawnTimeSeconds = 255f;
        public float DreadEliteSpawnIntervalSeconds = 360f;
        public float MinibossSpawnTimeSeconds = 360f;
        ...
        public int MinibossExperienceReward = 52;
        public float BossSpawnTimeSeconds = 1140f;
        ...
        public int BossExperienceReward = 165;
        ...
        public float WeaponCooldownSeconds = 0.74f;
        public float WeaponRange = 12f;
        public float ProjectileDamage = 6.4f;
        public float ProjectileSpeed = 9.25f;
        public float ProjectileRadius = 0.22f;
        public float ProjectileLifetimeSeconds = 2.25f;
        ...
        public float HitscanDamage = 4.4f;
        public float HitscanCooldownSeconds = 1.85f;
        ...
        public float GrenadeDamage = 5.8f;
        public float GrenadeCooldownSeconds = 3.5f;
        public float GrenadeRange = 7f;
        public int GrenadePayloadCount = 1;
        public float GrenadePayloadTravelSpeed = 6.8f;
        public float GrenadePayloadArmingSeconds = 0.82f;
        public float GrenadePayloadExplosionRadius = 2.1f;
        public float PlacedPayloadDamage = 5.2f;
        public float TrapCooldownSeconds = 3.7f;
        public float MineCooldownSeconds = 4.1f;
        public float PlacedPayloadRange = 5.8f;
        public int PlacedPayloadCount = 1;
        public float PlacedPayloadArmingSeconds = 0.82f;
        ...
        public float PickupAttractRange = 2.9f;
        ...
        public float GemRushCooldownMultiplierBonus = -0.035f;
        public float GemRushPickupRangeBonus = 0.62f;
        public float MajorRewardCacheAttractionSpeedMultiplier = 2.6f;
        public float RoamingCacheTravelInterval = 15f;
        public int RoamingCacheExperienceGemCount = 3;
        public int RoamingCacheMagnetInterval = 3;
        public int RoamingCacheBloodShardInterval = 5;
        public int RoamingCacheAmbushStartCache = 3;
        public int RoamingCacheAmbushInterval = 3;
        public int RoamingCacheAmbushBaseEnemyCount = 2;
        ...
        public float ArenaShrineTravelInterval = 60f;
        public int ArenaShrineBaseEnemyCount = 6;
        public int ArenaShrineEnemyCountIncreasePerTrial = 2;
        public int ArenaShrineMaxEnemyCount = 16;
        public int ArenaShrineExtraAliveAllowance = 18;
        public float ArenaShrineSpawnRadius = 5.4f;
        public int ArenaShrineClearExperienceGemCount = 6;
        public float ArenaShrineClearExperienceMultiplier = 3.1f;
        public int ArenaShrineClearBloodShardAmount = 2;
        public float ArenaShrineSurgeDurationSeconds = 6.5f;
        public float ArenaShrineSurgeDamageBonus = 1.55f;
        public float ArenaShrineSurgeMoveSpeedBonus = 0.24f;
        public float ArenaShrineSurgeCooldownMultiplierBonus = -0.045f;
        public float ArenaShrineSurgePickupRangeBonus = 0.6f;
        public float ArenaShrineSurgePulseDamage = 22f;
        public float ArenaShrineSurgePulseRadius = 5.4f;
        public float WaystoneDiscoveryRadius = 1.6f;
        public int WaystoneExperienceGemCount = 5;
        ...
        public int WaystoneChainInterval = 3;
        public int WaystoneChainBonusGemCount = 3;
        public float WaystoneChainDurationSeconds = 6f;
        public float WaystoneChainDamageBonus = 1.3f;
        public float WaystoneChainMoveSpeedBonus = 0.22f;
        public float WaystoneChainCooldownMultiplierBonus = -0.04f;
        public float WaystoneChainPickupRangeBonus = 0.58f;
        public float WaystoneChainPulseDamage = 16f;
        public float WaystoneChainPulseRadius = 4.9f;
        ...
        public int ExperienceRequiredBase = 6;
        public int ExperienceRequiredPerLevel = 4;
        public float WeaponLoadoutSurgeDurationSeconds = 5.5f;
        public float WeaponLoadoutSurgeDamageBonus = 1.45f;
        public float WeaponLoadoutSurgeMoveSpeedBonus = 0.2f;
        public float WeaponLoadoutSurgeCooldownMultiplierBonus = -0.045f;
        public float WeaponLoadoutSurgePickupRangeBonus = 0.52f;
        public float WeaponLoadoutSurgePulseDamage = 20f;
        public float WeaponLoadoutSurgePulseRadius = 5.2f;
        public float PassiveLoadoutSurgeDurationSeconds = 5.5f;
        public float PassiveLoadoutSurgeDamageBonus = 1.25f;
        public float PassiveLoadoutSurgeMoveSpeedBonus = 0.18f;
        public float PassiveLoadoutSurgeCooldownMultiplierBonus = -0.038f;
        public float PassiveLoadoutSurgePickupRangeBonus = 0.86f;
        public float PassiveLoadoutSurgeExperienceGainMultiplierBonus = 0.3f;
        public float PassiveLoadoutSurgePulseDamage = 18f;
        public float PassiveLoadoutSurgePulseRadius = 5f;
        ...
        public float EvolutionSurgeDamage = 36f;
        public float EvolutionSurgeRadius = 6.8f;
        public int EvolutionChainSurgeMinimumEvolutions = 2;
        public float EvolutionChainSurgeDurationSeconds = 7f;
        public float EvolutionChainSurgeDamageBonus = 1.8f;
        public float EvolutionChainSurgeMoveSpeedBonus = 0.24f;
        public float EvolutionChainSurgeCooldownMultiplierBonus = -0.055f;
        public float EvolutionChainSurgePickupRangeBonus = 0.68f;
        public float EvolutionChainSurgePulseDamage = 28f;
        public float EvolutionChainSurgePulseRadius = 6f;
        public float LevelUpPulseDamage = 9f;
        public float LevelUpPulseRadius = 4.1f;
        public float RewardUpgradeSurgeDamage = 20f;
        public float RewardUpgradeSurgeRadius = 5.4f;
        public int RewardJackpotExperienceGemBaseCount = 3;
        public int RewardJackpotExperienceGemPerRarityTier = 2;
        ...
        public float BossRelicSurgeDurationSeconds = 5.5f;
        public float BossRelicSurgeDamageBonus = 1.45f;
        public float BossRelicSurgeMoveSpeedBonus = 0.22f;
        public float BossRelicSurgeCooldownMultiplierBonus = -0.05f;
        public float BossRelicSurgePickupRangeBonus = 0.55f;
        public int EndlessSurgeExperienceGemCount = 4;
        public float EndlessSurgeExperienceMultiplier = 2.6f;
        public int EndlessSurgeBloodShardAmount = 1;
        public float EndlessSurgeDurationSeconds = 7f;
        public float EndlessSurgeDamageBonus = 1.45f;
        public float EndlessSurgeMoveSpeedBonus = 0.2f;
        public float EndlessSurgeCooldownMultiplierBonus = -0.04f;
        public float EndlessSurgePickupRangeBonus = 0.48f;
        public float EndlessSurgePulseDamage = 24f;
        public float EndlessSurgePulseRadius = 5.6f;
        ...
        public int DraftLateRarityLevel = 10;
        public int NormalEarlyCommonWeight = 100;
        public int NormalEarlyUncommonWeight = 80;
        public int NormalEarlyRareWeight = 18;
        public int NormalEarlyEpicWeight = 2;
        public int NormalEarlyLegendaryWeight = 0;
        public int NormalMidCommonWeight = 65;
        public int NormalMidUncommonWeight = 95;
        public int NormalMidRareWeight = 48;
        public int NormalMidEpicWeight = 12;
        public int NormalMidLegendaryWeight = 0;
        public int NormalLateCommonWeight = 45;
        public int NormalLateUncommonWeight = 78;
        public int NormalLateRareWeight = 68;
        public int NormalLateEpicWeight = 28;
    ...
    public static class BasicSurvivorsGame
    {
        ...
        public const string FateLensUpgradeId = "upgrade.survivors.fate-lens";
        public const string SoulflareGlyphUpgradeId = "upgrade.survivors.soulflare-glyph";
        ...
        public static readonly RunUpgradeEffectId DraftLuckEffect = new RunUpgradeEffectId("survivors.draft.luck");
        public static readonly RunUpgradeEffectId DeathNovaDamageEffect = new RunUpgradeEffectId("survivors.on_kill.nova_damage");
        public static readonly RunUpgradeEffectId DeathNovaRadiusEffect = new RunUpgradeEffectId("survivors.on_kill.nova_radius");
        ...
        public static readonly RunUpgradeTargetId DraftTarget = new RunUpgradeTargetId("survivors.draft");
        public static readonly RunUpgradeTargetId OnKillTarget = new RunUpgradeTargetId("survivors.on_kill");
        ...
        private static void ApplyNormalTuning(SurvivorsTemplateTuning tuning)
        {
            ...
            tuning.GemRushDurationSeconds = 3.4f;
            tuning.GemRushDamageBonus = 0.85f;
            tuning.GemRushMoveSpeedBonus = 0.18f;
            tuning.GemRushCooldownMultiplierBonus = -0.028f;
            tuning.GemRushPickupRangeBonus = 0.5f;
            tuning.HordeRushFirstTimeSeconds = 75f;
            tuning.HordeRushIntervalSeconds = 135f;
            tuning.HordeRushWarningLeadSeconds = 4f;
            tuning.HordeRushBaseEnemyCount = 12;
            ...
            tuning.PayloadHazardChainCooldownSeconds = 3f;
            tuning.PayloadHazardChainExperienceMultiplier = 1.9f;
            tuning.PayloadHazardChainPulseDamage = 12f;
            tuning.PayloadHazardChainPulseRadius = 4.4f;
            tuning.WeaponLoadoutSurgeDurationSeconds = 6f;
            tuning.WeaponLoadoutSurgeDamageBonus = 1.35f;
            tuning.WeaponLoadoutSurgeMoveSpeedBonus = 0.18f;
            tuning.WeaponLoadoutSurgeCooldownMultiplierBonus = -0.04f;
            tuning.WeaponLoadoutSurgePickupRangeBonus = 0.4f;
            tuning.WeaponLoadoutSurgePulseDamage = 18f;
            tuning.WeaponLoadoutSurgePulseRadius = 5f;
            tuning.PassiveLoadoutSurgeDurationSeconds = 6f;
            tuning.PassiveLoadoutSurgeDamageBonus = 1.15f;
            tuning.PassiveLoadoutSurgeMoveSpeedBonus = 0.16f;
            tuning.PassiveLoadoutSurgeCooldownMultiplierBonus = -0.032f;
            tuning.PassiveLoadoutSurgePickupRangeBonus = 0.78f;
            tuning.PassiveLoadoutSurgeExperienceGainMultiplierBonus = 0.28f;
            tuning.PassiveLoadoutSurgePulseDamage = 16f;
            tuning.PassiveLoadoutSurgePulseRadius = 4.9f;
            tuning.BossRelicSurgeDurationSeconds = 6f;
            tuning.BossRelicSurgeDamageBonus = 1.3f;
            tuning.BossRelicSurgeMoveSpeedBonus = 0.18f;
            tuning.BossRelicSurgeCooldownMultiplierBonus = -0.04f;
            tuning.BossRelicSurgePickupRangeBonus = 0.4f;
            tuning.EndlessSurgeExperienceGemCount = 5;
            tuning.EndlessSurgeExperienceMultiplier = 2.8f;
            tuning.EndlessSurgeBloodShardAmount = 1;
            tuning.EndlessSurgeDurationSeconds = 7f;
            tuning.EndlessSurgeDamageBonus = 1.65f;
            tuning.EndlessSurgeMoveSpeedBonus = 0.22f;
            tuning.EndlessSurgeCooldownMultiplierBonus = -0.045f;
            tuning.EndlessSurgePickupRangeBonus = 0.55f;
            tuning.EndlessSurgePulseDamage = 28f;
            tuning.EndlessSurgePulseRadius = 5.8f;
            tuning.LevelUpPulseDamage = 8f;
            tuning.LevelUpPulseRadius = 3.8f;
            tuning.EvolutionChainSurgeDamageBonus = 1.6f;
            tuning.EvolutionChainSurgeMoveSpeedBonus = 0.2f;
            tuning.EvolutionChainSurgeCooldownMultiplierBonus = -0.045f;
            tuning.EvolutionChainSurgePickupRangeBonus = 0.5f;
            tuning.EvolutionChainSurgePulseDamage = 24f;
            tuning.EvolutionChainSurgePulseRadius = 5.6f;
            ...
            tuning.ArenaShrineTravelInterval = 64f;
            tuning.ArenaShrineBaseEnemyCount = 7;
            tuning.ArenaShrineEnemyCountIncreasePerTrial = 2;
            tuning.ArenaShrineMaxEnemyCount = 18;
            tuning.ArenaShrineExtraAliveAllowance = 22;
            tuning.ArenaShrineSurgeDamageBonus = 1.75f;
            tuning.ArenaShrineSurgeMoveSpeedBonus = 0.28f;
            tuning.ArenaShrineSurgeCooldownMultiplierBonus = -0.05f;
            tuning.ArenaShrineSurgePickupRangeBonus = 0.68f;
            tuning.ArenaShrineSurgePulseDamage = 25f;
            tuning.ArenaShrineSurgePulseRadius = 5.8f;
            tuning.WaystoneChainInterval = 3;
            tuning.WaystoneChainBonusGemCount = 3;
            tuning.WaystoneChainDurationSeconds = 6f;
            tuning.WaystoneChainDamageBonus = 1.45f;
            tuning.WaystoneChainMoveSpeedBonus = 0.24f;
            tuning.WaystoneChainCooldownMultiplierBonus = -0.045f;
            tuning.WaystoneChainPickupRangeBonus = 0.64f;
            tuning.WaystoneChainPulseDamage = 18f;
            tuning.WaystoneChainPulseRadius = 5f;
        ...
        private static void ApplyDebugFastTuning(SurvivorsTemplateTuning tuning)
        {
            ...
            tuning.GemRushDamageBonus = 1.2f;
            tuning.GemRushMoveSpeedBonus = 0.24f;
            tuning.GemRushCooldownMultiplierBonus = -0.04f;
            tuning.GemRushPickupRangeBonus = 0.72f;
            tuning.HordeRushFirstTimeSeconds = 12f;
            tuning.HordeRushIntervalSeconds = 28f;
            tuning.HordeRushWarningLeadSeconds = 2f;
            tuning.HordeRushBaseEnemyCount = 14;
            tuning.HordeRushEnemyCountIncreasePerRush = 5;
            ...
            tuning.WeaponLoadoutSurgePickupRangeBonus = 0.62f;
            ...
            tuning.PassiveLoadoutSurgeDamageBonus = 1.55f;
            tuning.PassiveLoadoutSurgeMoveSpeedBonus = 0.24f;
            tuning.PassiveLoadoutSurgeCooldownMultiplierBonus = -0.048f;
            tuning.PassiveLoadoutSurgePickupRangeBonus = 1.05f;
            tuning.PassiveLoadoutSurgeExperienceGainMultiplierBonus = 0.42f;
            ...
            tuning.ArenaShrineTravelInterval = 34f;
            tuning.ArenaShrineBaseEnemyCount = 8;
            tuning.ArenaShrineEnemyCountIncreasePerTrial = 3;
            tuning.ArenaShrineMaxEnemyCount = 24;
            tuning.ArenaShrineExtraAliveAllowance = 30;
            tuning.ArenaShrineSpawnRadius = 4.8f;
            tuning.ArenaShrineClearExperienceGemCount = 8;
            tuning.ArenaShrineClearExperienceMultiplier = 3.8f;
            tuning.ArenaShrineClearBloodShardAmount = 3;
            tuning.ArenaShrineSurgeDurationSeconds = 5.5f;
            tuning.ArenaShrineSurgeDamageBonus = 2.35f;
            tuning.ArenaShrineSurgeMoveSpeedBonus = 0.38f;
            tuning.ArenaShrineSurgeCooldownMultiplierBonus = -0.065f;
            tuning.ArenaShrineSurgePickupRangeBonus = 0.9f;
            tuning.ArenaShrineSurgePulseDamage = 34f;
            tuning.ArenaShrineSurgePulseRadius = 6.4f;
            ...
            tuning.GemRushDurationSeconds = 3.6f;
            tuning.GemRushDamageBonus = 1f;
            ...
            tuning.WaystoneChainDamageBonus = 2f;
            ...
            tuning.WaystoneChainPulseDamage = 24f;
            tuning.WaystoneChainPulseRadius = 5.5f;
            ...
            tuning.BossRelicSurgeCooldownMultiplierBonus = -0.055f;
            tuning.BossRelicSurgePickupRangeBonus = 0.62f;
            tuning.EndlessSurgeExperienceGemCount = 6;
            tuning.EndlessSurgeExperienceMultiplier = 3.2f;
            tuning.EndlessSurgeBloodShardAmount = 2;
            tuning.EndlessSurgeDurationSeconds = 6f;
            tuning.EndlessSurgeDamageBonus = 2.2f;
            tuning.EndlessSurgeMoveSpeedBonus = 0.3f;
            tuning.EndlessSurgeCooldownMultiplierBonus = -0.06f;
            tuning.EndlessSurgePickupRangeBonus = 0.78f;
            tuning.EndlessSurgePulseDamage = 34f;
        ...
        private static void ApplyShowcaseTuning(SurvivorsTemplateTuning tuning)
        {
            ...
            tuning.HordeRushFirstTimeSeconds = 45f;
            tuning.HordeRushIntervalSeconds = 90f;
            tuning.HordeRushWarningLeadSeconds = 3f;
            tuning.HordeRushBaseEnemyCount = 12;
            tuning.HordeRushEnemyCountIncreasePerRush = 4;
            ...
            tuning.PayloadHazardChainSnareThreshold = 4;
            tuning.PayloadHazardChainWindowSeconds = 1.2f;
            tuning.PayloadHazardChainCooldownSeconds = 2.6f;
            tuning.PayloadHazardChainExperienceGemCount = 3;
            tuning.PayloadHazardChainExperienceMultiplier = 2f;
            tuning.PayloadHazardChainPulseDamage = 14f;
            tuning.PayloadHazardChainPulseRadius = 4.6f;
            ...
            tuning.ArenaShrineTravelInterval = 52f;
            tuning.ArenaShrineBaseEnemyCount = 7;
            tuning.ArenaShrineEnemyCountIncreasePerTrial = 2;
            tuning.ArenaShrineMaxEnemyCount = 20;
            tuning.ArenaShrineExtraAliveAllowance = 24;
            tuning.ArenaShrineClearExperienceGemCount = 7;
            tuning.ArenaShrineClearExperienceMultiplier = 3.4f;
            tuning.ArenaShrineSurgeDurationSeconds = 6f;
            tuning.ArenaShrineSurgeDamageBonus = 1.9f;
            tuning.ArenaShrineSurgeMoveSpeedBonus = 0.32f;
            tuning.ArenaShrineSurgeCooldownMultiplierBonus = -0.055f;
            tuning.ArenaShrineSurgePickupRangeBonus = 0.74f;
            tuning.ArenaShrineSurgePulseDamage = 28f;
            tuning.ArenaShrineSurgePulseRadius = 6f;
            tuning.GemRushDurationSeconds = 3.4f;
            tuning.GemRushDamageBonus = 0.9f;
            tuning.GemRushMoveSpeedBonus = 0.2f;
            tuning.GemRushCooldownMultiplierBonus = -0.03f;
            tuning.GemRushPickupRangeBonus = 0.55f;
            ...
            tuning.WaystoneChainInterval = 2;
            tuning.WaystoneChainBonusGemCount = 4;
            tuning.WaystoneChainDurationSeconds = 5.5f;
            tuning.WaystoneChainDamageBonus = 1.6f;
            tuning.WaystoneChainMoveSpeedBonus = 0.3f;
            tuning.WaystoneChainCooldownMultiplierBonus = -0.05f;
            tuning.WaystoneChainPickupRangeBonus = 0.7f;
            tuning.WaystoneChainPulseDamage = 20f;
            tuning.WaystoneChainPulseRadius = 5.2f;
            tuning.WeaponLoadoutSurgeDamageBonus = 1.55f;
            tuning.WeaponLoadoutSurgeMoveSpeedBonus = 0.22f;
            tuning.WeaponLoadoutSurgeCooldownMultiplierBonus = -0.045f;
            tuning.WeaponLoadoutSurgePickupRangeBonus = 0.5f;
            tuning.WeaponLoadoutSurgePulseDamage = 20f;
            tuning.WeaponLoadoutSurgePulseRadius = 5.2f;
            tuning.PassiveLoadoutSurgeDamageBonus = 1.35f;
            tuning.PassiveLoadoutSurgeMoveSpeedBonus = 0.2f;
            tuning.PassiveLoadoutSurgeCooldownMultiplierBonus = -0.04f;
            tuning.PassiveLoadoutSurgePickupRangeBonus = 0.9f;
            tuning.PassiveLoadoutSurgeExperienceGainMultiplierBonus = 0.34f;
            tuning.PassiveLoadoutSurgePulseDamage = 18f;
            tuning.PassiveLoadoutSurgePulseRadius = 5f;
            tuning.RewardUpgradeSurgeDamage = 18f;
            tuning.RewardUpgradeSurgeRadius = 5f;
            tuning.BossRelicSurgeDamageBonus = 1.55f;
            tuning.BossRelicSurgeMoveSpeedBonus = 0.22f;
            tuning.BossRelicSurgeCooldownMultiplierBonus = -0.045f;
            tuning.BossRelicSurgePickupRangeBonus = 0.5f;
            tuning.EndlessSurgeExperienceGemCount = 5;
            tuning.EndlessSurgeExperienceMultiplier = 3f;
            tuning.EndlessSurgeBloodShardAmount = 1;
            tuning.EndlessSurgeDurationSeconds = 6.5f;
            tuning.EndlessSurgeDamageBonus = 1.85f;
            tuning.EndlessSurgeMoveSpeedBonus = 0.25f;
            tuning.EndlessSurgeCooldownMultiplierBonus = -0.05f;
            tuning.EndlessSurgePickupRangeBonus = 0.62f;
            tuning.EndlessSurgePulseDamage = 30f;
            tuning.EndlessSurgePulseRadius = 6f;
            tuning.LevelUpPulseDamage = 9f;
            tuning.LevelUpPulseRadius = 3.9f;
            tuning.EvolutionChainSurgeDamageBonus = 1.8f;
            tuning.EvolutionChainSurgeMoveSpeedBonus = 0.24f;
            tuning.EvolutionChainSurgeCooldownMultiplierBonus = -0.05f;
            tuning.EvolutionChainSurgePickupRangeBonus = 0.6f;
            tuning.EvolutionChainSurgePulseDamage = 26f;
            tuning.EvolutionChainSurgePulseRadius = 5.8f;
        ...
        public static RunUpgradeCatalog CreateRunUpgradeCatalog()
        {
            return new RunUpgradeCatalog(new[]
            {
                ...
                Upgrade(FateLensUpgradeId, RunUpgradeRarity.Rare, 22, 4, DraftLuckEffect, DraftTarget, 0.2d),
                UpgradeMulti(
                    SoulflareGlyphUpgradeId,
                    RunUpgradeRarity.Rare,
                    22,
                    4,
                    new RunUpgradeEffectDescriptor(DeathNovaDamageEffect, OnKillTarget, 5.0d),
                    new RunUpgradeEffectDescriptor(DeathNovaRadiusEffect, OnKillTarget, 0.22d)),
        ...
        public static IReadOnlyList<SurvivorsRunUpgradeMetadata> CreateRunUpgradeMetadata()
        {
            return new[]
            {
                ...
                UpgradeMetadata(SoulflareGlyphUpgradeId, "Soulflare Glyph", SurvivorsRunUpgradeCategory.Passive, SurvivorsRunBuildSlotKind.Passive, OnKillTarget.Value, "Passive: weapon kills burst outward and damage nearby enemies."),
                ...
                UpgradeMetadata(TempestPrismEvolutionUpgradeId, "Tempest Prism", SurvivorsRunUpgradeCategory.Evolution, SurvivorsRunBuildSlotKind.None, StarBeamWeaponContentId, "Evolution: Star Beam becomes a rapid prism that splits into angled side beams and arcing refractions.", StarBeamWeaponContentId, StarFocusUpgradeId, 5, TwinCharmUpgradeId),
                UpgradeMetadata(GravefieldEngineEvolutionUpgradeId, "Gravefield Engine", SurvivorsRunUpgradeCategory.Evolution, SurvivorsRunBuildSlotKind.None, GravityGrenadeWeaponContentId, "Evolution: payload detonations seed snaring satellite danger fields.", GravityGrenadeWeaponContentId, BiggerBoomsUpgradeId, 4, GiantRuneUpgradeId),
                ...
                UpgradeMetadata(AetherfieldMatrixEvolutionUpgradeId, "Aetherfield Matrix", SurvivorsRunUpgradeCategory.Evolution, SurvivorsRunBuildSlotKind.None, RuneTrapWeaponContentId, "Evolution: Rune Trap and Aether Mine seed snaring satellite hazard fields.", RuneTrapWeaponContentId, RuneLatticeUpgradeId, 5, SiegePayloadsUpgradeId)
            };
        }
        ...
        public static string GetUpgradeDisplayName(RunUpgradeId id)
        {
            ...
            if (value == SoulflareGlyphUpgradeId) return "Soulflare Glyph";
