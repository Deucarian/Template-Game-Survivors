...
- PlayMode coverage checks the expanded default loadout, XP-gain and area-scaling passives, early/boss rarity weighting, and class-gated advanced weapon availability.
