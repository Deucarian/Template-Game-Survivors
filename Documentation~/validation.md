...
- PlayMode coverage checks roaming cache special-drop, ambush, and ambush-clear payoff beats using deterministic cache cadence tuning.
...
- Combat, pickup, and reward feedback coverage checks enemy hit flashes, short-lived enemy death bursts, magnet recall feedback, evolution-triggered XP recall, normal level-up Level Pulse damage, low-health Clutch Pulse safety and enemy damage, Gem Rush pickup-cluster stat boosts, XP attraction feedback, pulsing recalled gem presentation, rarity-card presentation, and selected reward banners.
