...
- telegraphed major-threat slam attacks for dread elites, minibosses, and bosses
...
- short-lived primitive visuals, Arc Step dash feedback, roaming arena reward caches with optional special drops, clearable ambush packs, major-enemy pickup caches with cache-pull attraction, and HUD banners for sample-only feedback
