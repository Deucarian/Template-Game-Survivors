...
If the player has not claimed a passive yet, normal level-up drafts reserve a Common/Uncommon passive hook before filling the rest of the cards normally. This helps build identity start forming in the opening drafts while preserving the normal rarity table for the remaining options.
