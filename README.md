...
The scene contains a tiny bootstrap object. At runtime it creates the run-mode selector, arena, player, enemy/pickup/projectile pools, camera, run timer, HUD, draft UI, relic UI, meta profile service, result summary state, endless continuation, and restart flow.
