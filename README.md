...
- ten enemy pressure types with splitters, ranged pressure, regular support-calling Rift Callers, timed horde-rush rings, low-health support call-ins for major threats, two elite variants, and long-run escalation instead of one swarm profile
