...
Boss relic drafts are current-run collection picks: once a relic is selected, later boss relic drafts remove it from the candidate pool, and the reward chain resumes normally if every relic has already been claimed.
