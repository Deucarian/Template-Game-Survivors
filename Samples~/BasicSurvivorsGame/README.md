...
- Defeat the miniboss, collect the reward cache burst, and pick an elite upgrade reward.
- Watch the major-threat health bar drop while fighting the miniboss and final boss, back away from their slam warning pulse, then dodge the support ring each major threat calls in near low health.
