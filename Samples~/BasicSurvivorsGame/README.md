...
- The editable sample content includes `Content/DefaultRunFlow/run-flow.json` for pacing-profile reference values: spawn pressure, ranged-shot dodge XP rewards, elite cadence, horde rush timing, roaming cache cadence, draft thresholds, weapon/passive slot limits, rarity weights, endless intervals, boss timing, and victory timing.
