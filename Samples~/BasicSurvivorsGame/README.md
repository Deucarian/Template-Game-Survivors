...
- Long movement through the endless arena keeps recentering floor tiles and colored waystones around the player, drops small roaming XP caches, and later caches can add magnet recall pickups, shard bonuses, or clearable trailing ambush packs so repositioning has a reward beat with some pressure.
