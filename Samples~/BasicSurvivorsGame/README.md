...
- Keep moving across the arena long enough to reach a colored waystone and see its discovery reward, then keep roaming until a later cache adds a special pickup, ambush, or Wayfinder Surge; clearing the pack should drop a small XP burst, and a surge cache should briefly improve damage, cooldown, movement, and pickup attraction.
